...
const BugsActionCard: React.FC<{
  ...
  return (
    <div>
      <div style={!isMobile ? classes.inputs: classes.inputs.mobileStyles}>
        <div style={!isMobile ? classes.searchBarWrapper: classes.searchBarWrapper.mobileStyles}>
          <FilterBar
        ...
        <div style={!isMobile ? classes.sortBarWrapper: classes.sortBarWrapper.mobileStyles}>
          <SortBar
            sortBy={sortBy}
      ...
      <div style={!isMobile ? classes.flexWrapper: classes.flexWrapper.mobileStyles}>
        <FormDialog
          triggerBtn={
            isMobile
              ? {
